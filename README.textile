...
<pre>RAILS_ENV=development jruby script/import/import_til_db features/rdf</pre>

Mot test:

<pre>RAILS_ENV=test jruby script/import/import_til_db features/rdf</pre>
...
# installere jruby -S gem install webrat
