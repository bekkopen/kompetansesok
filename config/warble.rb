...
Warbler::Config.new do |config|
  config.jruby_complete_jar = Rails.root + '/lib/ext/jruby-complete-1.1.6.jar'
  ...
  config.excludes = FileList['lib/ext/jruby-complete-*.jar', 'tmp/sphinx*'] # Warbler has its own way of bundling it
  ...
  # of RAILS_ROOT
  config.war_name = "kompetansesok_#{Rails.env}"
