Egenskap: Vise fag
  ...
  Kunne se kompetansemålene og kompetansemaalsettene som hører til et fag
  ...
  Scenario: Fremvisning av kompetansemål
    ...
    Og skal jeg få opp følgende treff i kompetansemål:
      | Tittel starter med                                                                                      |
      | gjere greie for verknaden av aktivitetar på den fysiske og mentale helsa hos brukarane, og dokumentere  |
  ...
  Scenario: Framvisning med kompetansemålsett
    Gitt at jeg ser på fag med uuid uuid:2a5b44fa-6475-4bba-8fd1-e2e58b461864
    Så skal jeg kunne se faget "Administrasjonsfag"
