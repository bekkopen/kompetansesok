...
* <code>jruby -S gems:install</code>
...
* Restart Glassfish
** <code>asadmin stop-domain domain1</code>
...
* <code>git tag -a "v0.1.0" -m "Release 0.1.0"</code>
* <code>git push bekkopen master</code>
* <code>git push bekkopen master --tags</code>