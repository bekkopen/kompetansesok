...
Og så fra serveren:
  ...
  sudo /usr/share/glassfish/bin/asadmin deploy --user admin --contextroot / /tmp/kompetansesok_production.war
...
Må prøve dette igjen. I mellomtiden:
  ...
  # TODO: Gjøre om til Rake task 0g fjerne script filene (og ref i warbler config)
  java -jar lib/jruby-complete.jar script/import/import_til_fil /tmp/kompetansesok
